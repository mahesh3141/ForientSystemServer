  ...
  <div class="geo-details">
    <table class="table">
      <tr>
        ...
        <td><input readonly="true" align="left" type="text" data-geo="country" value="" id="setting_country" name="setting_country" class="form-control"></td>
      </tr>
      <tr style="display: none">
        <td align="left">Country code</td>
        <td><input readonly="true" type="text" data-geo="country_short" value="" id="setting_country_short" name="setting_country_short" class="form-control"></td>
      </tr>
      <tr>
        <td align="left">State</td>
        <td><input readonly="true" type="text" data-geo="administrative_area_level_1" value="" id="setting_state" name="setting_state" class="form-control"></td>
      </tr>
      <tr style="display: none">
        <td align="left">State code</td>
        <td><input readonly="true" type="text" data-geo="administrative_area_level_1_short" value="" id="setting_state_short" name="setting_state_short" class="form-control"></td>
      </tr>
      <tr>
        <td align="left">City</td>
        <td><input readonly="true" type="text" data-geo="administrative_area_level_2" value="" id="setting_city" name="setting_city" class="form-control"></td>
      </tr>
      <tr style="display: none">
        <td align="left">Latitude</td>
        <td><input readonly="true" type="text" data-geo="lat" value="" id="setting_latitude" name="setting_latitude" class="form-control"></td>
      </tr>
      <tr style="display: none">
        <td align="left">Longitude</td>
        <td><input readonly="true" type="text" data-geo="lng" value="" id="setting_longitude" name="setting_longitude" class="form-control"></td>
      </tr>
    </table>
  </div>
   </div>
