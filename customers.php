...
$filter_data = array('ID', 'First Name', 'Last Name', 'Gender', 'Phone', 'Created At', 'Updated At');
        ...
        <form class="form form-inline" action="">
            ...
            <select name="filter_col" class="form-control">
                ...
                foreach ($filter_options as $key => $option) {
                    ...
                    echo ' <option value="' . $option . '" ' . $selected . '>' . $filter_data[$index] . '</option>';
                    $index++;
                }
                ?>
            ...
            <?php foreach ($customers as $key => $row) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <div class="modal fade" id="assign-task-<?php echo $row['id'] ?>" role="dialog">
                                ...
                                <form action="addTask.php" method="POST">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Select employee to assign a task</p>
                                            <input type="hidden" name="cust_id" id = "cust_id" value="<?php echo $row['id'] ?>">

                                            <label for ="input_order">Employee Name</label>
                           ...
                           title="Edit Customer" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
                            ...
                            <a href="" title="Delete Customer" class="btn btn-danger delete_btn" data-toggle="modal" 
                               data-target="#confirm-delete-<?php echo $row['id'] ?>" style="margin-right: 8px;">
                                ...
                                </div> <!-- Delete Confirmation Modal end-->
                            <?php endforeach; ?>      
                            </tbody>
                            </table>
